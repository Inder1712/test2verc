  ...
  return (
    <div>
      ...
      <div className="h-auto w-full flex p-3 mb-6">
        <button
          className="h-12 w-64 sm:w-80 bg-[rgb(133,88,49)] hover:bg-[rgb(107,70,37)] flex justify-center items-center text-lg sm:text-xl text-white rounded-lg disabled:opacity-70"
